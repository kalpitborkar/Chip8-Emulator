...
void Chip8::init() // Initialize
{
    ...
    for (int i = 0; i < 80; i++) // Load fontset into memory
    {
    ...
    for (int i = 0; i < 16; i++) // Clear V registers, stack and keys
    {
        V[i] = 0;
        stack[i] = 0;
        key[i] = 0;
...
void Chip8::emulate_cycle() // Emulate a single cycle
{
    // 1. Fetch the opcode
    ...
    case 0x0000:
        ...
        case 0x0000: // 00E0 - Clear screen
            ...
            pc += 2;
            break;
        case 0x000E: // 00E0 - Return from subroutine
            --sp;
            pc = stack[sp];
            pc += 2;
            break;
